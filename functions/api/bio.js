...
const SYSTEM_PROMPT = [
  ...
  "- Open with a strong verb-led sentence. Avoid \"is the author of\" as the very first phrase â€” it's the most overused indie-author opener.",
  ...
  "- End the long bio with a soft personal hook (lives in/loves X), never with \"...is currently working on her next novel\" â€” too generic.",
  "",
  "Format your response as markdown:",
  "",
  "## Short bio (150-200 chars)",
  "[bio text â€” plain prose, no markdown, no quotes]",
  "",
  ...
  "- Update the long bio whenever you launch a new book â€” readers Google your name and the About page is what they find."
].join("\n");
